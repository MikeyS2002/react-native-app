    ...
    <View style={{
      ...
      <View style={{
        ...
        alignItems: "center"
          ...
          <Text style={{fontFamily: FONTS.semiBold, fontSize: SIZES.large * 1.3, color: COLORS.white}}>Bob's favourite NFTs</Text>
            <View stlye={{width: 45, height: 45}}>
              <Image 
          ...
          Let's find a masterpiece
                ...
                <View style={{marginTop: SIZES.font}}>
                  <View style={{
                    ...
                    <TextInput placeholder='Search NFTs' style={{ flex: 1}} onChange={() => {}}/>
                  </View>
                </View>
